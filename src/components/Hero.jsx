...
export default function Hero({ T }) {
  ...
  return (
    ...
    >
      ...
      {[
        { x: "-10%", y: "10%", c1: "rgba(0,191,255,0.12)", c2: "rgba(139,92,246,0.08)", size: 600, delay: "0s" },
        { x: "60%", y: "30%", c1: "rgba(139,92,246,0.10)", c2: "rgba(0,191,255,0.06)", size: 500, delay: "-7s" },
        { x: "20%", y: "60%", c1: "rgba(0,191,255,0.06)", c2: "rgba(139,92,246,0.12)", size: 400, delay: "-14s" },
      ].map((b, i) => (
        <div
          key={i}
          style={{
          ...
          >
            {HERO_STATS.map((stat) => (
              <div key={stat.l}>
                ...
                <div style={{ fontSize: 13, color: T.text3, marginTop: 2 }}>{stat.l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        ...
        <div
          style={{
            width: 1,
            height: 48,
            background: `linear-gradient(${T.accent}, transparent)`,
          }}
        />
      </div>
    </section>
